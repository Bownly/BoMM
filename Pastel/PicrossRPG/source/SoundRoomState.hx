...
class SoundRoomState extends FlxState
{
	...
	var songWorldMap:FlxSound = FlxG.sound.load("assets/music/za warudo map.wav");
	...
	var songFinalFight:FlxSound = FlxG.sound.load("assets/music/the final pick ross.wav");
	...
	override public function update():Void
	{
		...
		if (FlxG.keys.anyJustPressed(["J"]))
		{
			switch (selectedSelection)
			{
				...
				case (1):
					FlxG.sound.playMusic("assets/music/za warudo map.wav");
				case (2):
					FlxG.sound.playMusic("assets/music/battle.wav");
				case (3):
					FlxG.sound.playMusic("assets/music/victoly fanfare.wav");
				case (4):
					FlxG.sound.playMusic("assets/music/lost the battle.wav");
				case (5):
					FlxG.sound.playMusic("assets/music/the final pick ross.wav");
