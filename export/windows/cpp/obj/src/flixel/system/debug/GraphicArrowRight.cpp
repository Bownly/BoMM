...
{
HX_STACK_FRAME("flixel.system.debug.GraphicArrowRight","new",0x7bbb3ee5,"flixel.system.debug.GraphicArrowRight.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1737)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::debug::GraphicArrowRight_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1737)
...
{  hx::ObjectPtr< GraphicArrowRight_obj > result = new GraphicArrowRight_obj();
...
Dynamic GraphicArrowRight_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicArrowRight_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicArrowRight_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicArrowRight_obj::__mClass;

void GraphicArrowRight_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug.GraphicArrowRight"), hx::TCanCast< GraphicArrowRight_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug_GraphicArrowRight");
}
