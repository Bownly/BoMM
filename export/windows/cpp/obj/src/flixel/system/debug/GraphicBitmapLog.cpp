...
{
HX_STACK_FRAME("flixel.system.debug.GraphicBitmapLog","new",0xf8da4027,"flixel.system.debug.GraphicBitmapLog.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< GraphicBitmapLog_obj > result = new GraphicBitmapLog_obj();
...
Dynamic GraphicBitmapLog_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicBitmapLog_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicBitmapLog_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicBitmapLog_obj::__mClass;

void GraphicBitmapLog_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug.GraphicBitmapLog"), hx::TCanCast< GraphicBitmapLog_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug_GraphicBitmapLog");
}
