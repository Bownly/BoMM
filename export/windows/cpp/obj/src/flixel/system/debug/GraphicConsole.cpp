...
{
HX_STACK_FRAME("flixel.system.debug.GraphicConsole","new",0x7eeec0a9,"flixel.system.debug.GraphicConsole.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1737)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::debug::GraphicConsole_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1737)
...
{  hx::ObjectPtr< GraphicConsole_obj > result = new GraphicConsole_obj();
...
Dynamic GraphicConsole_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicConsole_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicConsole_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicConsole_obj::__mClass;

void GraphicConsole_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug.GraphicConsole"), hx::TCanCast< GraphicConsole_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug_GraphicConsole");
}
