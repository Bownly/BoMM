...
{
HX_STACK_FRAME("flixel.system.debug._FlxDebugger.GraphicDrawDebug","new",0x07c1b10b,"flixel.system.debug._FlxDebugger.GraphicDrawDebug.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1737)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::debug::_FlxDebugger::GraphicDrawDebug_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1737)
...
{  hx::ObjectPtr< GraphicDrawDebug_obj > result = new GraphicDrawDebug_obj();
...
Dynamic GraphicDrawDebug_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicDrawDebug_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicDrawDebug_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicDrawDebug_obj::__mClass;

void GraphicDrawDebug_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug._FlxDebugger.GraphicDrawDebug"), hx::TCanCast< GraphicDrawDebug_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug__FlxDebugger_GraphicDrawDebug");
}
