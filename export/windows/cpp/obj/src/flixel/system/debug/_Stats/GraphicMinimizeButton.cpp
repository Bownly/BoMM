...
{
HX_STACK_FRAME("flixel.system.debug._Stats.GraphicMinimizeButton","new",0xfc967524,"flixel.system.debug._Stats.GraphicMinimizeButton.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1737)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::debug::_Stats::GraphicMinimizeButton_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1737)
...
{  hx::ObjectPtr< GraphicMinimizeButton_obj > result = new GraphicMinimizeButton_obj();
...
Dynamic GraphicMinimizeButton_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicMinimizeButton_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicMinimizeButton_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicMinimizeButton_obj::__mClass;

void GraphicMinimizeButton_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug._Stats.GraphicMinimizeButton"), hx::TCanCast< GraphicMinimizeButton_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug__Stats_GraphicMinimizeButton");
}
