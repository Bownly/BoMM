...
{
HX_STACK_FRAME("flixel.system.debug._VCR.GraphicOpen","new",0x5cfdc604,"flixel.system.debug._VCR.GraphicOpen.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1737)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::debug::_VCR::GraphicOpen_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1737)
...
{  hx::ObjectPtr< GraphicOpen_obj > result = new GraphicOpen_obj();
...
Dynamic GraphicOpen_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicOpen_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicOpen_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicOpen_obj::__mClass;

void GraphicOpen_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug._VCR.GraphicOpen"), hx::TCanCast< GraphicOpen_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicOpen");
}
