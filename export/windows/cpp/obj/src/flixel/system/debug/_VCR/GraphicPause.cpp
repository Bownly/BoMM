...
{
HX_STACK_FRAME("flixel.system.debug._VCR.GraphicPause","new",0x93ef75a0,"flixel.system.debug._VCR.GraphicPause.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1737)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::debug::_VCR::GraphicPause_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1737)
...
{  hx::ObjectPtr< GraphicPause_obj > result = new GraphicPause_obj();
...
Dynamic GraphicPause_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicPause_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicPause_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicPause_obj::__mClass;

void GraphicPause_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug._VCR.GraphicPause"), hx::TCanCast< GraphicPause_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicPause");
}
