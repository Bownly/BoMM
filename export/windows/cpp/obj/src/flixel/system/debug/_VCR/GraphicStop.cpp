...
{
HX_STACK_FRAME("flixel.system.debug._VCR.GraphicStop","new",0x0e7c2e3c,"flixel.system.debug._VCR.GraphicStop.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1737)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::debug::_VCR::GraphicStop_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1737)
...
{  hx::ObjectPtr< GraphicStop_obj > result = new GraphicStop_obj();
...
Dynamic GraphicStop_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicStop_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicStop_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicStop_obj::__mClass;

void GraphicStop_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug._VCR.GraphicStop"), hx::TCanCast< GraphicStop_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicStop");
}
