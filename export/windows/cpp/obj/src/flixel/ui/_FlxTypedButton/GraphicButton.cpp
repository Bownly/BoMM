...
{
HX_STACK_FRAME("flixel.ui._FlxTypedButton.GraphicButton","new",0xdd7c5cff,"flixel.ui._FlxTypedButton.GraphicButton.new","openfl/_legacy/Assets.hx",1669,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1737)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::ui::_FlxTypedButton::GraphicButton_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1737)
