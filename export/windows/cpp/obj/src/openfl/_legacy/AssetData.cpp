...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_legacy::AssetType*/ ,(int)offsetof(AssetData_obj,type),HX_CSTRING("type")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.AssetData"), hx::TCanCast< AssetData_obj> ,sStaticFields,sMemberFields,
