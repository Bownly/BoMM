...
::openfl::_legacy::media::Sound AssetLibrary_obj::getMusic( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getMusic",0xa68a2b8e,"openfl._legacy.AssetLibrary.getMusic","openfl/_legacy/Assets.hx",1241,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1241)
...
Void AssetLibrary_obj::loadText( ::String id,Dynamic handler){
{
		...
		Void run(::openfl::_legacy::utils::ByteArray bytes){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/_legacy/Assets.hx",1354,0x9276b055)
