...
Void Assets_obj::loadLibrary( ::String name,Dynamic handler){
{
		...
		if (((bool((data != null())) && bool((data != HX_CSTRING("")))))){
			...
			HX_STACK_LINE(883)
			::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no asset library named \"") + name) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),883,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadLibrary")));
		}
		HX_STACK_LINE(889)
		handler(null()).Cast< Void >();
	}
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		if (((library != null()))){
			...
			if ((library->exists(symbolName,::openfl::_legacy::AssetType_obj::MUSIC))){
				...
				HX_STACK_LINE(940)
				::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no Sound asset with an ID of \"") + id1->__get((int)0)) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),940,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadMusic")));
			}
		}
		else{
			HX_STACK_LINE(946)
			::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),946,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadMusic")));
		}
		HX_STACK_LINE(952)
		handler1->__GetItem((int)0)(null()).Cast< Void >();
	}
...
Void Assets_obj::loadMovieClip( ::String id,Dynamic handler){
{
		...
		if (((library != null()))){
			...
			if ((library->exists(symbolName,::openfl::_legacy::AssetType_obj::MOVIE_CLIP))){
				...
				HX_STACK_LINE(976)
				::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no MovieClip asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),976,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadMovieClip")));
			}
		}
		else{
			HX_STACK_LINE(982)
			::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),982,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadMovieClip")));
		}
		HX_STACK_LINE(988)
		handler(null()).Cast< Void >();
	}
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		if (((library != null()))){
			...
			if ((library->exists(symbolName,::openfl::_legacy::AssetType_obj::SOUND))){
				...
				HX_STACK_LINE(1039)
				::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no Sound asset with an ID of \"") + id1->__get((int)0)) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),1039,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadSound")));
			}
		}
		else{
			HX_STACK_LINE(1045)
			::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),1045,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadSound")));
		}
		HX_STACK_LINE(1051)
		handler1->__GetItem((int)0)(null()).Cast< Void >();
	}
...
Void Assets_obj::loadText( ::String id,Dynamic handler){
{
		...
		if (((library != null()))){
			...
			if ((library->exists(symbolName,::openfl::_legacy::AssetType_obj::TEXT))){
				...
				HX_STACK_LINE(1075)
				::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no String asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),1075,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadText")));
			}
		}
		else{
			HX_STACK_LINE(1081)
			::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),1081,HX_CSTRING("openfl._legacy.Assets"),HX_CSTRING("loadText")));
		}
		HX_STACK_LINE(1087)
		handler(null()).Cast< Void >();
	}
...
::Class Assets_obj::resolveClass( ::String name){
	HX_STACK_FRAME("openfl._legacy.Assets","resolveClass",0x1c65baf3,"openfl._legacy.Assets.resolveClass","openfl/_legacy/Assets.hx",1122,0x9276b055)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(1122)
...
{
		HX_STACK_FRAME("openfl._legacy.Assets","library_onEvent",0x9a352310,"openfl._legacy.Assets.library_onEvent","openfl/_legacy/Assets.hx",1178,0x9276b055)
		HX_STACK_ARG(library,"library")
		HX_STACK_ARG(type,"type")
		HX_STACK_LINE(1178)
