...
Void Stage_obj::__onKey( Dynamic event,::String type){
{
		...
		if (((stack->length > (int)0))){
			...
			if ((keyboardEvent->__getIsCancelled())){
				...
				HX_STACK_LINE(854)
				if (((bool((bool((((int(flags) & int(::openfl::_legacy::display::Stage_obj::efAltDown))) > (int)0)) && bool((type == ::openfl::_legacy::events::KeyboardEvent_obj::KEY_DOWN)))) && bool((event->__Field(HX_CSTRING("code"),true) == (int)13))))){
					HX_STACK_LINE(859)
