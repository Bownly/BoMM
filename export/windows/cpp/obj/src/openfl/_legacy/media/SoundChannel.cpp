...
int loops = __o_loops.Default(0);
{
	...
	if (((handle != null()))){
		HX_STACK_LINE(72)
		Dynamic _g1 = ::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_create(handle,startTime,loops,this->__transform);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(72)
		this->__handle = _g1;
	}
	HX_STACK_LINE(76)
...
Void SoundChannel_obj::stop( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(110)
		if (((bool((this->__soundInstance != null())) && bool((this->__soundInstance->__audioType == ::openfl::_legacy::media::InternalAudioType_obj::MUSIC))))){
			HX_STACK_LINE(112)
			if (((::openfl::_legacy::media::SoundChannel_obj::__audioState != null()))){
				HX_STACK_LINE(113)
				::openfl::_legacy::media::SoundChannel_obj::__audioState->remove(hx::ObjectPtr<OBJ_>(this));
			}
		}
		HX_STACK_LINE(120)
		::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_stop(this->__handle);
		HX_STACK_LINE(121)
		this->__handle = null();
		HX_STACK_LINE(122)
...
Float SoundChannel_obj::get_leftPeak( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(276)
	return ::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_get_left(this->__handle);
}
...
Float SoundChannel_obj::get_rightPeak( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(277)
	return ::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_get_right(this->__handle);
}
...
Float SoundChannel_obj::set_pitch( Float value){
	...
	HX_STACK_LINE(279)
	::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_set_pitch(this->__handle,value);
	HX_STACK_LINE(279)
...
Float SoundChannel_obj::get_position( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(280)
	return ::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_get_position(this->__handle);
}
...
Float SoundChannel_obj::set_position( Float value){
	...
	HX_STACK_LINE(281)
	return ::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_set_position(this->__handle,_g);
}
...
::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
	...
	if (((this->__transform == null()))){
		...
		HX_STACK_LINE(302)
		this->__transform->leftToLeft = value->leftToLeft;
		HX_STACK_LINE(303)
		this->__transform->leftToRight = value->leftToRight;
		HX_STACK_LINE(304)
		this->__transform->pan = value->pan;
		HX_STACK_LINE(305)
		this->__transform->rightToLeft = value->rightToLeft;
		HX_STACK_LINE(306)
		this->__transform->rightToRight = value->rightToRight;
		HX_STACK_LINE(307)
		this->__transform->volume = value->volume;
	}
	HX_STACK_LINE(310)
	::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_set_transform(this->__handle,this->__transform);
	HX_STACK_LINE(312)
	return value;
}
...
::openfl::_legacy::media::SoundChannel SoundChannel_obj::createDynamic( Dynamic handle,::openfl::media::SoundTransform soundTransform,::openfl::_legacy::events::EventDispatcher dataProvider){
	...
	HX_STACK_LINE(87)
	::openfl::_legacy::media::SoundChannel result = ::openfl::_legacy::media::SoundChannel_obj::__new(null(),(int)0,(int)0,soundTransform);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(89)
	result->__dataProvider = dataProvider;
	HX_STACK_LINE(90)
	result->__handle = handle;
	HX_STACK_LINE(91)
	::openfl::_legacy::media::SoundChannel_obj::__incompleteList->push(result);
	HX_STACK_LINE(93)
	(::openfl::_legacy::media::SoundChannel_obj::__dynamicSoundCount)++;
	HX_STACK_LINE(96)
	::openfl::events::SampleDataEvent request = ::openfl::events::SampleDataEvent_obj::__new(::openfl::events::SampleDataEvent_obj::SAMPLE_DATA,null(),null());		HX_STACK_VAR(request,"request");
	HX_STACK_LINE(97)
	Float _g = ::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_get_data_position(handle);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(97)
	request->position = _g;
	HX_STACK_LINE(98)
...
void SoundChannel_obj::__boot()
{
	...
	lime_sound_channel_get_left= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_sound_channel_get_left"),(int)1);
	lime_sound_channel_get_right= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_sound_channel_get_right"),(int)1);
	lime_sound_channel_get_position= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_sound_channel_get_position"),(int)1);
	lime_sound_channel_set_position= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_sound_channel_set_position"),(int)2);
	...
	lime_sound_channel_stop= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_sound_channel_stop"),(int)1);
	lime_sound_channel_create= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_sound_channel_create"),(int)4);
	lime_sound_channel_set_transform= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_sound_channel_set_transform"),(int)2);
	lime_sound_channel_set_pitch= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_sound_channel_set_pitch"),(int)2);
