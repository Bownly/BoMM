...
Void MagentaWeapon_obj::shoot( ::Player _player){
{
		...
		if (((  (((_g < _player->_maxBullets))) ? bool((this->juice >= this->juiceCost)) : bool(false) ))){
			...
			if ((_player->flipX)){
				...
				HX_STACK_LINE(32)
				::weapons::Bullet newBullet2 = ::weapons::Bullet_obj::__new((_player->x - (int)8),(_player->y + (int)16),(int)500,(int)256,(_player->_DAMAGE + this->damage),(int)256);		HX_STACK_VAR(newBullet2,"newBullet2");
				HX_STACK_LINE(33)
				...
				HX_STACK_LINE(38)
				::weapons::Bullet newBullet = ::weapons::Bullet_obj::__new((_player->x + (int)8),(_player->y + (int)8),(int)500,(int)256,(_player->_DAMAGE + this->damage),(int)256);		HX_STACK_VAR(newBullet,"newBullet");
				HX_STACK_LINE(39)
