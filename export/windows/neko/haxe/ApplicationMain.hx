...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "HaxeFlixelVlog", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "HaxeFlixelVlog";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HaxeFlixelVlog", null, { width: 640, height: 480 });
